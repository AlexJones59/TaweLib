...
public class UserManager {
   ...
   */
  public static void createCustomerAccount(Library library, String firstName, String lastName,
      String phoneNumber, String houseNumber, String street, String city, String postcode) {
    Customer newCustomer =
        new Customer(firstName, lastName, phoneNumber, houseNumber, street, city, postcode);
   ...
   * @param postcode the postcode
   */
  public static void createLibrarianAccount(Library library, String firstName, String lastName,
      LocalDateTime employmentDate, String phoneNumber, String houseNumber, String street,
      String city, String postcode) {
    Librarian newLibrarian = new Librarian(firstName, lastName, phoneNumber, houseNumber, street,
        city, postcode, employmentDate);
   ...
   */
  @Deprecated
  public static void updateCustomerAccount(Library library, String username, String firstName,
      String lastName, String phoneNumber, String houseNumber, String street, String city,
      String postcode) {
   ...
   * @param postcode the postcode
   */
  public static void updateCustomerAccount(Library library, Customer customer, String firstName,
      String lastName, String phoneNumber, String houseNumber, String street, String city,
      String postcode) {
    updateUserAccount(library, customer, firstName, lastName, phoneNumber, houseNumber, street,
        city, postcode);
  }
   ...
   */
  @Deprecated
  public static void updateLibrarianAccount(Library library, String username, String firstName,
      String lastName, String phoneNumber, String houseNumber, String street, String city,
      String postcode) {
   ...
   * @param postcode the postcode
   */
  public static void updateLibrarianAccount(Library library, Librarian librarian, String firstName,
      String lastName, String phoneNumber, String houseNumber, String street, String city,
      String postcode) {
    updateUserAccount(library, librarian, firstName, lastName, phoneNumber, houseNumber, street,
        city, postcode);
  }
   ...
   */
  public static void updateUserAccount(Library library, User user, String firstName,
      String lastName, String phoneNumber, String houseNumber, String street, String city,
      String postcode) {
   ...
   */
  public static void topUpAccountBalance(Library library, String customerUsername, int amount) {
    ...
    library.getCustomerRepository().getSpecific(customerUsername).increaseAccountBalance(amount);
  }
